...
export default function Hero({ timeText, setAllocationModal }) {
  return (
    <section id="hero" className="relative py-8 lg:py-12 px-6 h-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center z-10">
      ...
      <div className="lg:col-span-7 flex flex-col justify-center reveal-on-scroll relative z-10 concrete-texture">
